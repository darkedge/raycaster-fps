...
// C:\Repositories\raycaster-fps\tools\bgfx\shaderc.exe -f .\rasterizer\fs_rasterizer.sc -o C:\Repositories\raycaster-fps\src\client\shaders\rasterizer\fs_rasterizer.h --platform windows --Type f --Profile ps_5_0 --bin2c --debug
...
uniform SamplerState s_TextureArraySampler : register(s[0]); uniform Texture2DArray s_TextureArrayTexture : register(t[0]); static BgfxSampler2DArray s_TextureArray = { s_TextureArraySampler, s_TextureArrayTexture };

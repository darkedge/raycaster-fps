...
// C:\Repositories\raycaster-fps\tools\bgfx\shaderc.exe -f .\rasterizer\vs_rasterizer.sc -o C:\Repositories\raycaster-fps\src\client\shaders\rasterizer\vs_rasterizer.h --platform windows --Type v --Profile vs_5_0 --bin2c --debug
...
Output main( float3 a_position : POSITION , float3 a_texcoord0 : TEXCOORD0) { Output _varying_; _varying_.v_texcoord0 = float3(0.0, 0.0, 0.0);;
{
